...
var all = function(mode, mysqlconnection, callback) {
   ...
   async.parallel({
      poloniex: function(callback) {polo.ratesGet(mode, mysqlconnection, function(rates){callback(null,rates)})},
      bitstamp: function(callback) {bitstamp.ratesGet(mode, mysqlconnection, function(rates){callback(null,rates)})}
   }, function(e, rates){
      callback(rates);
   });
};
