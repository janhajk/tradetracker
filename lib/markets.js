   ...
   */
   'okex': {
      url: function() {
         ...
         var api_key = process.env.APIOKEX_KEY;
         var api_secret = process.env.APIOKEX_SECRET;
   ...
   'bitz.com': {
      url: function() {return {url:'https://apiv2.bitz.com/Market/tickerall'}},
      fData: function(data) {
         var nData = {};
         for (let i in data.data) {
            nData[data.data[i].symbol] = data.data[i];
         }
         return nData;
      },
      keys:  {
